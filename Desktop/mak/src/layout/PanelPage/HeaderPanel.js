                                ...
                                <div className="hidden w-full md:block">
                                    <div className=" flex justify-between items-baseline space-x-4">
                                        <div className='flex items-center '>
                                            ...
                                            <div className=' ml-10'>
                                                <span className='border border-slate-300 hover:border-indigo-300 cursor-pointer text-black bg-white py-3 px-8' onClick={()=>props.active("items")}>کالاها</span>

                                                <span className='border border-slate-300 hover:border-indigo-300 cursor-pointer text-black bg-white py-3 px-8' onClick={()=>props.active("price")}>موجودی و قیمت ها</span>
                                                <span className='border border-slate-300 hover:border-indigo-300 cursor-pointer text-black bg-white py-3 px-8' onClick={()=>props.active("orders")}>سفارش ها</span>
