...
function Navigation(props) {
  ...
  return <>
    ...
    <div>
      <nav className={` bg-blue-500 ${styles.container} `}>
              ...
              <div className="hidden w-full md:block">
                <div className=" flex justify-between items-baseline space-x-4">
                  <div className="relative">
                    {<Link className=" ml-7 hover:text-white hover:bg-blue-400  text-gray-700 px-3 py-2 rounded-md text-sm font-medium text-xl " to="/LoginPage"> مدیریت </Link>}

                    {<Link className="  hover:text-white hover:bg-blue-400 text-gray-700 px-3 py-2 rounded-md text-sm font-medium text-xl relative" to='/CartPage'>سبد خرید </Link>}
                  ...
                  <div className={`flex items-center `}>
                    ...
                    {<Link className="text-xl hover:text-white hover:bg-blue-400  hover:transition-opacity  text-gray-700 px-3 py-2 rounded-md text-sm font-medium" to='/'>صفحه اصلی </Link>}

                    {<Link className="text-xl hover:text-white hover:bg-blue-400  text-gray-700 px-3 py-2 rounded-md text-sm font-medium mr-5 ml-3" to='/CategoriesPage'>دسته بندی ها  </Link>}
                  </div>
        ...
        >
          {(ref) => (
            <div className="bg-green-300  md:hidden" id="mobile-menu">
              <div ref={ref} className="flex flex-col items-end px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <div className=' flex w-full justify-center items-center'>
                  {<Link className=" text-xl  hover:text-white hover:bg-green-500  hover:text-right  text-gray-700 px-3 py-2 rounded-md text-sm font-medium" to="/LoginPage">مدیریت</Link>}

                  {<Link className="text-xl hover:text-white hover:bg-green-500  hover:text-right  text-gray-700 px-3 py-2 rounded-md text-sm font-medium" to='/CartPage'>سبد خرید</Link>}



                  {<Link className="text-xl hover:text-white hover:bg-green-500 hover:text-right hover:transition-opacity text-gray-700 px-3 py-2 rounded-md text-sm font-medium" to='/'>صفحه اصلی </Link>}

                  {<Link className="text-xl hover:text-white hover:bg-green-500 hover:text-right text-gray-700 px-3 py-2 rounded-md text-sm font-medium " to='/CategoriesPage'>دسته بندی ها  </Link>}
