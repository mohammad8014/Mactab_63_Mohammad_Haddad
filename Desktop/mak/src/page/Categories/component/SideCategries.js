                    ...
                    <nav className="mt-1  ">
                        <a className="py-2 px-8  text-gray-700 " href="#">
                            <div className="flex border-r-4 border-gray-700 justify-end items-center py-2  bg-gray-200 text-gray-700  ">
                                ...
                                <Link to={`/CategoriesPage/Laptop`} className="mx-4 font-bold text-xl">لپ تاپ  </Link>
                        ...
                        <a className="py-2 px-8  text-gray-700 " href="#">
                            <div className="flex border-r-4 border-gray-700 justify-end items-center py-2  bg-gray-200 text-gray-700  ">
                                ...
                                <Link to={`/CategoriesPage/mobile`} className="mx-4 font-bold text-xl">موبایل  </Link>
                        ...
                        <a className="py-2 px-8  text-gray-700 " href="#">
                            <div className="flex border-r-4 border-gray-700 justify-end items-center py-2  bg-gray-200 text-gray-700  ">
                                ...
                                <Link  to={`/CategoriesPage/watch`} className="mx-4 font-bold text-xl">ساعت  </Link>
